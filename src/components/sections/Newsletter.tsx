  ...
  return (
    <section id="newsletter" className="bg-[#F5F3EE] px-4 py-24 text-center sm:px-6 lg:px-8">
      <motion.div
        ...
        variants={fadeUp}
        className="relative mx-auto max-w-6xl overflow-hidden rounded-[3rem] bg-[#112BFF] px-5 py-12 text-center text-white shadow-[0_35px_100px_rgba(17,43,255,0.28)] sm:px-12 sm:py-20"
      >
        ...
        <div className="relative z-10 mx-auto max-w-3xl space-y-7 text-center">
          ...
          <h2 className="text-center text-3xl font-black tracking-tight sm:text-5xl lg:text-6xl">Get First Access To Fresh Drops</h2>
